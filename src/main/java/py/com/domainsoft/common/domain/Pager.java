package py.com.domainsoft.common.domain;

/**
 * Se usa para calcular la cantidad de botones que se mostrarán en una página
 *
...
public class Pager {
    ...
    public void setButtonsToShow(int buttonsToShow) {
        if (buttonsToShow % 2 != 0) {
            ...
            throw new IllegalArgumentException("Debe ser un valor impar!");
        }
    }
